...
class NTXentMultiplePositives(_Loss):
    ...
    def forward(self, z1, z2, **kwargs) -> Tensor:
        ...
        z2 = z2.view(batch_size, -1, metric_dim)  # [batch_size, num_conformers, metric_dim]
        #z2 = z2.view(batch_size, -1, metric_dim)  # [batch_size, num_conformers, metric_dim]
        #z2 = z2.view(batch_size, 3, metric_dim)  # [batch_size, num_conformers, metric_dim]
        #z2 = z2.view(batch_size, 3, metric_dim)  # [batch_size, num_conformers, metric_dim]
        ...
        # ref cosine sim eqs 
        if self.norm:
            z1_abs = z1.norm(dim=1) # [batch_size]
            z2_abs = z2.norm(dim=2) # [batch_size, num_conformers]
            sim_matrix = sim_matrix / torch.einsum('i,ju->iju', z1_abs, z2_abs) # [batch_size, batch_size, num_conformers]
